    ...
    for p in sorted_players:
        ...
        player_row = f"""
            <tr data-last="{last_start}" data-player-name="{p.get("name", "–")}">
                ...
                <td class="player-name" style="white-space:nowrap;"><strong>{player_display_name}{df_fire}{top_impact}{' ⚽️' if unique_goal_leader and player_display_name == unique_goal_leader else ''}{' 👟' if unique_assist_leader and player_display_name == unique_assist_leader else ''}</strong></td>
