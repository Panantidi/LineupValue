...
check_contains("msg has <a href",         msg, '<a href="https://x11radar.ru/lineup_ai/compare/')
check_contains("msg has HTML-escaped url", msg, "&amp;")
check_contains("msg has match id",        msg, "mid=YRWOt1od")
check_not_contains("msg no bare URL",     msg, "(https://")
check_not_contains("msg no parens-url",   msg, " - Fulham (https://")
